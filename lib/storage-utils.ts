import { SettingsState, Theme, DEFAULT_THEME } from "@/lib/typing-constants";
...
export const DEFAULT_SETTINGS: Omit<SettingsState, "presetText" | "plan" | "planIndex" | "theme"> = {
  mode: "time",
  duration: 30,
  wordTarget: 25,
  punctuation: false,
...
export function saveSettings(settings: SettingsState): void {
  ...
  try {
    ...
    window.localStorage.setItem(STORAGE_KEYS.SETTINGS, JSON.stringify(persistableSettings));
  } catch (error) {
