...
export default function GhostWriterSettingsModal({
  ...
  useEffect(() => {
    setCustomSpeed(settings.ghostWriterSpeed);
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-6">
          ...
          {/* Speed Selection */}
          <div className={`space-y-4 transition-opacity duration-200 ${!settings.ghostWriterEnabled ? "opacity-50 pointer-events-none" : ""}`}>
            
            <div className="flex flex-col gap-3">
              <label className="text-sm text-gray-400 text-center">Target Speed (WPM)</label>
              ...
              <div className="flex items-center justify-center gap-3 mt-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    onBlur={() => {
                      const clampedSpeed = Math.max(1, Math.min(500, customSpeed));
                    ...
                    style={{ "--tw-ring-color": GLOBAL_COLORS.brand.primary } as React.CSSProperties}
                  />
                  <button
                    type="button"
                    onClick={() => {
            ...
            <p className="text-xs text-gray-500 text-center mt-4">
              The ghost cursor shows where you would be typing at the target speed
            </p>
