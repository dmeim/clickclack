...
export const CATEGORY_CONFIG: Record<ThemeCategory, CategoryConfig> = {
  ...
  food: { displayName: "Food", order: 30 },
  fun: { displayName: "Fun", order: 31 },
  holiday: { displayName: "Holiday", order: 32 },
  // Collections/Misc
  zodiac: { displayName: "Zodiac", order: 33 },
  gemstones: { displayName: "Gemstones", order: 34 },
  instruments: { displayName: "Instruments", order: 35 },
  dance: { displayName: "Dance", order: 36 },
  vehicles: { displayName: "Vehicles", order: 37 },
  comics: { displayName: "Comics", order: 38 },
  "historical-era": { displayName: "Historical Eras", order: 39 },
  emotions: { displayName: "Emotions", order: 40 },
  textiles: { displayName: "Fabrics & Textures", order: 41 },
};
